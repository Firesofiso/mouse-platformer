...
namespace TarodevController {
    ...
    public class PlayerController : MonoBehaviour, IPlayerController {
        ...
        [HideInInspector]
        private Rigidbody2D _rb; // Hide is for serialization to avoid errors in gizmo calls
        ...
        protected virtual void CheckCollisions() {
            ...
            _hittingWall = Physics2D.CapsuleCast(
                ...
                _col.direction,
                0,
                new Vector2(_input.FrameInput.Move.x, 0),
                _stats.GrounderDistance,
                ~_stats.PlayerLayer
            );
        ...
        private void OnValidate() {
            ...
            if (_standingCollider == null)
                Debug.LogWarning(
                    "Please assign a Capsule Collider to the Standing Collider slot",
                    this
                );
            if (_crouchingCollider == null)
                Debug.LogWarning(
                    "Please assign a Capsule Collider to the Crouching Collider slot",
                    this
                );
