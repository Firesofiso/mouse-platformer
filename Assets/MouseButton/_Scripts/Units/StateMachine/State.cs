...
public abstract class State : MonoBehaviour {
    ...
    // -1 = let the unit's animator decide. Override to declare which clip this state owns.
    public virtual int AnimationHash => -1;
    ...
    protected void PlayAnimation(int hash) {
        if (hash == _currentAnimHash || Animator == null) return;
